...
--
-- Servidor: localhost
-- Tiempo de generación: 10-02-2022 a las 14:09:25
...
(18, 'Peb Wooden Legs', 'peb_wooden', 'Infiniti', 'Sillón de líneas suaves y confortables, Peb muestra una personalidad importante y esencial, jugando con las dos alturas de respaldo disponibles. Ahora, se presenta en la versión patas de madera. Está completamente tapizado y es perfecto para las áreas de salón de la vida contemporánea.', 'Por definir', '', 'products/PEB_49h91YM.webp', '', '', '2022-01-21 17:32:59.775244', '2022-02-09'),
(19, 'Bench X5', 'x5', 'Quadrifoglio', 'La gama X5 ha sido diseñada para ofrecer flexibilidad y múltiples posibilidades de configuración, líneas limpias y agradables que se adaptan y se integran perfectamente entre el entorno de trabajo y todos los usuarios.', 'Por definir', '', 'products/Bench_X5.webp', 'products/Bench_x5_iEQvVXJ.webp', '', '2022-01-21 17:36:19.491997', '2022-02-09'),
(20, 'Cynara', 'cynara', 'Okamura', 'Experimente la máxima ligereza y la comodidad de Cynara, una silla operativa que integra una funcionalidad intuitiva y receptiva con una estética refinada y limpia para completar cualquier entorno de trabajo.', 'Por definir', '', 'products/Cynara.webp', 'products/Cynara_N2ujWyB.webp', '', '2022-01-21 17:36:58.166232', '2022-02-09'),
(21, 'Finora', 'finora', 'Okamura', 'Finora fue diseñado para encapsular la belleza con una delgadez y ligereza aerodinámicas. Al aplicar la filosofía de diseño que es distintiva de la industria automotriz, Finora brinda al trabajador moderno un alto nivel de funcionalidad para el máximo nivel de comodidad en una silla de oficina sin sacrificar el diseño estético.', 'Gris', '', 'products/Finora.webp', 'products/FINORA_11zon.webp', '', '2022-01-21 17:37:33.829521', '2022-02-09'),
(22, 'Ada close', 'ada_close', 'Requiez', 'Sillón de nombre Poltrona Ada Closed, cuentan con estructura interna de acero y esquineros en madera. \r\nSu asiento y respaldo fabricados en poliuretano inyectado de alta densidad con retardante de flama, elemento de guarda lateral para dispositivo móvil o revistero.', 'Por definir', '', 'products/ADA_CLOSED.webp', 'products/ADA_CLOSED_11zon.webp', '', '2022-01-21 18:24:30.619012', '2022-02-09'),
...
(24, 'Outline pad', 'outline', 'Requiez', 'Color, sencillez, comodidad: esta silla tiene muchas virtudes, debido a su estructura amplia y limpia, disponible en blanco, negro, azul oscuro, tabaco y marsala, también con panel de asiento tapizado. El marco apilable está disponible en blanco, negro y cromo. La familia comprende versiones con patín, patín con reposabrazos y 4 patas.', 'Por definir', '', 'products/Pad_Outline.webp', 'products/Pad_outline_WUQ3ODg.webp', '', '2022-01-21 18:28:06.386522', '2022-02-09'),
(25, 'Holes', 'holes', 'Requiez', 'Asiento de polipropileno y respaldo de polipropileno reforzado con fibra de vidrio, con cubierta exterior del asiento de polipropileno.\r\nSu asiento, respaldo pueden adquirirse en versión antiincendios. Apoyabrazos de polipropileno.\r\nLos ganchos de conexión del asiento se suministran directamente en los pies con ganchos de alambre de 6 mm de diámetro soldados a la base.\r\nPosibilidad de pies sin ganchos; ambas versiones de pies pueden llevar almohadillas de fieltro antirayaduras.', 'Dove gray', '', 'products/Holes.webp', 'products/Holes_LuPUv5S.webp', '', '2022-01-21 18:28:55.498960', '2022-02-09'),
(26, 'Redonda', 'redonda', 'Requiez', 'Silla con asiento en polipropileno y respaldo en polipropileno con fibra de vidrio.\r\nVersión con estructura sin reposabrazos en alambre de 11 mm doblado y soldado nivelado. \r\nMáxima apilabilidad: 45 sillas con carro especial con ruedas de goma para alta carga. Acabado del marco: pintado en color dove gray.\r\nBarras de unión entre filas disponibles en el catálogo.', 'Dove gray', '', 'products/Redonda.webp', 'products/Redonda_HE7esL7.webp', '', '2022-01-21 18:30:07.248960', '2022-02-09'),
...
(1, 'TANIA QUIRARTE', 'Evolución en los espacios de oficina', '16 FEBRERO', ''),
(2, 'ELISA ALVES', 'Mindfullness', '17 FEBRERO - 11:30 AM', 'webinars/Elisa_Alves.webp'),
(3, 'GABRIELA CHÁVEZ', 'Diseñar para disfrutar, disfrutar para trabajar', '17 FEBRERO - 4:00 PM', 'webinars/Gabriela_Chavez.webp'),
